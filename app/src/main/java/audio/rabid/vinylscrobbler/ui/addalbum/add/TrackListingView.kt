...
class TrackListingView @JvmOverloads constructor(
    ...
    companion object {
        private val SAMPLE_DATA = listOf(
            ...
            Track("A3", "Copper Mines", Duration.ofSeconds(837)),
...
fun Duration.getLocalizedString(context: Context): String {
    ...
    return if (h == 0L) {
        context.getString(R.string.duration_format_standard, m, s)
    } else {
        context.getString(R.string.duration_format_hours, h, m, s)
    }
}
